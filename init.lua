...
use(
          ...
          require("lf").setup(
              {
                  escape_quit = false,
                  border = "rounded",
                  highlights = {FloatBorder = {guifg = require('monokai').setup {} }}
              }
          )
  ...
  use { 'nvim-telescope/telescope.nvim', branch = '0.1.x', requires = { { 'nvim-lua/plenary.nvim' }, { 'kdheepak/lazygit.nvim' }, { 'nvim-telescope/telescope-file-browser.nvim' } },
      config = function()
...
vim.keymap.set('n', '<leader>gg', require('telescope').extensions.lazygit.lazygit, { desc = '[G]o [G]it' })
